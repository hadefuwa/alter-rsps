...
class WildernessObeliskPlugin(
    ...
    init {
        // Register handlers for all wilderness obelisk object IDs
        val obeliskIds = arrayOf(
            "obelisk_14825",
            "obelisk_14826", 
            "obelisk_14827",
            "obelisk_14828",
    ...
    private fun activateObelisk(player: Player) {
        // Check if player can teleport (wilderness level restrictions, etc.)
        if (!player.canTeleport(OBELISK_TELEPORT_TYPE)) {
            return
        }
