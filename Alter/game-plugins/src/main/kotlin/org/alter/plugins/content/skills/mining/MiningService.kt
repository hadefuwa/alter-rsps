...
/**
 * Loads the mining configuration so that entries can be retrieved at runtime.
 */
class MiningService : Service {
    ...
    override fun init(server: Server, world: World, serviceProperties: ServerProperties) {
        val file = Paths.get(serviceProperties.get("mining.rocks") ?: "data/cfg/mining/rocks.json")
