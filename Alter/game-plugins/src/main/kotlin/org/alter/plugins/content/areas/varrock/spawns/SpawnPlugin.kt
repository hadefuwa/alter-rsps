...
class SpawnPlugin(
    ...
    init {
         ...
         */
        spawnNpc(npc = "npc.guard_11912", x = 3211, z = 3424, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.guard_11913", x = 3213, z = 3424, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.guard_11914", x = 3209, z = 3424, walkRadius = 5, direction = Direction.SOUTH)
         ...
         */
        spawnNpc(npc = "npc.guard_11912", x = 3210, z = 3469, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.guard_11913", x = 3212, z = 3469, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.guard_11914", x = 3214, z = 3469, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.guard_11915", x = 3216, z = 3469, walkRadius = 5, direction = Direction.SOUTH)
         ...
         */
        spawnNpc(npc = "npc.guard_11912", x = 3208, z = 3380, walkRadius = 8, direction = Direction.NORTH)
        spawnNpc(npc = "npc.guard_11913", x = 3218, z = 3380, walkRadius = 8, direction = Direction.NORTH)
        spawnNpc(npc = "npc.guard_11914", x = 3205, z = 3385, walkRadius = 8, direction = Direction.EAST)
        spawnNpc(npc = "npc.guard_11915", x = 3221, z = 3385, walkRadius = 8, direction = Direction.WEST)
         ...
         */
        spawnNpc(npc = "npc.guard_11912", x = 3208, z = 3395, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.guard_11913", x = 3218, z = 3395, walkRadius = 5, direction = Direction.SOUTH)
         ...
         */
        spawnNpc(npc = "npc.guard_11914", x = 3208, z = 3395, height = 1, walkRadius = 5, direction = Direction.NORTH)
        spawnNpc(npc = "npc.guard_11915", x = 3218, z = 3395, height = 1, walkRadius = 5, direction = Direction.NORTH)
        /**
