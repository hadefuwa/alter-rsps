...
class SpawnPlugin(
    ...
    init {
        ...
        */
        ...
        spawnNpc(npc = "npc.spiritual_warrior", x = 2897, z = 5303, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_warrior", x = 2891, z = 5299, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        
        spawnNpc(npc = "npc.spiritual_mage", x = 2906, z = 5301, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_mage", x = 2894, z = 5303, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_mage", x = 2890, z = 5297, height = 2, walkRadius = 5, direction = Direction.SOUTH)

        spawnNpc(npc = "npc.spiritual_ranger", x = 2902, z = 5302, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_ranger", x = 2891, z = 5303, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_ranger", x = 2888, z = 5295, height = 2, walkRadius = 5, direction = Direction.SOUTH)

        spawnNpc(npc = "npc.knight_of_saradomin", x = 2901, z = 5303, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.knight_of_saradomin_2214", x = 2889, z = 5304, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        ...
        */
        ...
        spawnNpc(npc = "npc.spiritual_warrior_2243", x = 2857, z = 5327, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_warrior_2243", x = 2861, z = 5325, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        
        spawnNpc(npc = "npc.spiritual_mage_2244", x = 2856, z = 5331, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_mage_2244", x = 2859, z = 5325, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_mage_2244", x = 2858, z = 5321, height = 2, walkRadius = 5, direction = Direction.SOUTH)

        spawnNpc(npc = "npc.spiritual_ranger_2242", x = 2857, z = 5329, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_ranger_2242", x = 2861, z = 5325, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_ranger_2242", x = 2857, z = 5322, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        ...
        spawnNpc(npc = "npc.goblin_2246", x = 2883, z = 5325, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.goblin_2245", x = 2880, z = 5323, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.goblin_2246", x = 2877, z = 5321, height = 2, walkRadius = 5, direction = Direction.SOUTH)
        ...
        */
        ...
        spawnNpc(npc = "npc.spiritual_warrior_3166", x = 2874, z = 5287, height = 2, walkRadius = 10, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_warrior_3166", x = 2873, z = 5284, height = 2, walkRadius = 10, direction = Direction.SOUTH)
        
        spawnNpc(npc = "npc.spiritual_mage_3168", x = 2869, z = 5284, height = 2, walkRadius = 10, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_mage_3168", x = 2877, z = 5284, height = 2, walkRadius = 10, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.spiritual_mage_3168", x = 2876, z = 5281, height = 2, walkRadius = 10, direction = Direction.SOUTH)
