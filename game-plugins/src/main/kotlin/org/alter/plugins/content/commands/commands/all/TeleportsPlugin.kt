...
class TeleportsPlugin(
    ...
    init {
        ...
        spellbookInterfaces.forEach { interfaceId ->
            // Component 7 is the main home teleport button
        ...
        // Additional home teleport buttons on interface 218 (Standard spellbook)
        // Components 104 and 148 are also home teleport buttons
        listOf(104, 148).forEach { componentId ->
            onButton(interfaceId = 218, component = componentId) {
                val option = player.getInteractingOption()
