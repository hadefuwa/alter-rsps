...
class MyBossPlugin(
    ...
    init {
        ...
        setCombatDef("npc.balance_elemental") {
            ...
            sound {
                attackSound = Sound.BALANCE_ELEMENTAL_ATTACK  // Sound when boss attacks
                ...
                blockSound = Sound.BALANCE_ELEMENTAL_HIT     // Sound when boss blocks
                ...
                deathSound = Sound.BALANCE_ELEMENTAL_DEATH   // Sound when boss dies
