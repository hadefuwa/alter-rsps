 ...
 *
 * This plugin creates a Portal Nexus-style teleportation system similar to POH portals. Players can
 * interact with a portal object to access a menu of teleport destinations.
 *
 * Features:
 ...
 */
class NexusPortalPlugin(r: PluginRepository, world: World, server: Server) :
        KotlinPlugin(r, world, server) {

    companion object {
        /** All available teleport destinations organized by category */
        private val TELEPORT_LOCATIONS =
                listOf(
                        ...
                        "Vorkath" to Tile(x = 2271, z = 4049, height = 0),
                        "Dagannoth Kings" to Tile(x = 2900, z = 4449, height = 0),
                        "Zulrah" to Tile(x = 2273, z = 3077, height = 0),
                        ...
                        "Catacombs of Kourend" to Tile(x = 1666, z = 10048, height = 0),
                        "Smoke Dungeon" to Tile(x = 2397, z = 9441, height = 0),
                        ...
                        "Brimhaven Dungeon Steel/Iron dragons" to
                                Tile(x = 2722, z = 9443, height = 0),
                        ...
                        "Prifddinas" to Tile(x = 3263, z = 6074, height = 0),
                        ...
                        "Wilderness: Dark Warriors' Fortress" to
                                Tile(x = 3012, z = 3632, height = 0),
                        ...
                        "Cave to  Zemouregal castle (directly west of Trollweiss Mountain)" to
                                Tile(x = 2810, z = 10264, height = 0),
                        "Tale of Muspah buriel cave w/ jellies" to
                                Tile(x = 2833, z = 10330, height = 0),
                        ...
                        "Mountain daughter dungeon/The Kendal" to
                                Tile(x = 2787, z = 10077, height = 0),
                        ...
                        "Recipe For Disaster Goblin Village Kitchen" to
                                Tile(x = 2980, z = 9910, height = 0),
                        "Recipe For Disaster Goblin Village exploded" to
                                Tile(x = 2979, z = 9868, height = 0),
                        "Camdozaal (Sacred Forge) Under Ice mountain" to
                                Tile(x = 3038, z = 9889, height = 0),
                        ...
                        "Edgeville Dungeon Wilderness Druids" to
                                Tile(x = 3115, z = 9930, height = 0),
                        "Varrock Dungeon Moss Giants" to Tile(x = 3159, z = 9903, height = 0),
                        "Varrock Sewers" to Tile(x = 3239, z = 9866, height = 0),
                        "Varrock West Bank Basement" to Tile(x = 3191, z = 9826, height = 0),
                        "Champions Challenge/Champions Guild Basement" to
                                Tile(x = 3167, z = 9767, height = 0),
                        "Draynor Manor Basement (ernest chicken w/ levers)" to
                                Tile(x = 3112, z = 9754, height = 0),
                        ...
                        "Asgarnia Ice Dungeon Ice Warriors/Giants" to
                                Tile(x = 3050, z = 9581, height = 0),
                        "Asgarnia Ice Dungeon Skeletal Wyverns" to
                                Tile(x = 3050, z = 9549, height = 0),
                        ...
                        "Karamja Jogre Cave (Jungle Potion)" to
                                Tile(x = 2838, z = 9520, height = 0),
                        ...
                        "Yanille Agility Dungeon Poison Spider Pit Trap" to
                                Tile(x = 2578, z = 9578, height = 0),
                        "Yanille Agility Dungeon stairs & rubble before end" to
                                Tile(x = 2616, z = 9568, height = 0),
                        ...
                        "Castle Wars Saradomin Waiting Area" to
                                Tile(x = 2379, z = 9490, height = 0),
                        "Caslte Wars Dungeon" to Tile(x = 2401, z = 9506, height = 0),
                        "Feldip Hills Cave (I think ,no map data part of quest)(no ! on map)" to
                                Tile(x = 2520, z = 9322, height = 0),
                        "Feldip Hills Cave (same as above, could be Rantz cave)" to
                                Tile(x = 2647, z = 9392, height = 0),
                        "Mobolising Armies Basement" to Tile(x = 2393, z = 9245, height = 0),
                        "Observatory Dungeon (no map data but 99% sure)" to
                                Tile(x = 2356, z = 9391, height = 0),
                        "Underground Pass Exit to Elven Area" to
                                Tile(x = 2316, z = 9625, height = 0),
                        ...
                        "Underground Pass before killing unicorn" to
                                Tile(x = 2397, z = 9605, height = 0),
                        "Underground Pass After killing unicorn" to
                                Tile(x = 2373, z = 9606, height = 0),
                        ...
                        "Gnome Stronghold South-West House Dungeon" to
                                Tile(x = 2388, z = 9821, height = 0),
                        "Gnome Stronghold Grand Tree Black Demon fight" to
                                Tile(x = 2483, z = 9865, height = 0),
                        "Gnome Stronghold Hanger (Monkey Maddness)" to
                                Tile(x = 2390, z = 9895, height = 0),
                        "Lighthouse Dungeon" to Tile(x = 2521, z = 10018, height = 0),
                        "Piscatoris Summoning Obelisk" to Tile(x = 2333, z = 10013, height = 0),
                        "Relleka Dungeon Thorvald the Warrior" to
                                Tile(x = 2658, z = 10086, height = 0),
                        "Relleka Dungeon Swensen the Navigator Maze" to
                                Tile(x = 2641, z = 10027, height = 0),
                        "Temple of Ikov Boots of Lightness room" to
                                Tile(x = 2641, z = 9763, height = 0),
                        "Temple of Ikov Boots of Lightness dark" to
                                Tile(x = 2642, z = 9740, height = 0),
                        "Temple of Ikov Armadyl Room" to Tile(x = 2643, z = 9907, height = 0),
                        "Ardougne East to West Sewers (Plague City)" to
                                Tile(x = 2517, z = 9754, height = 0),
                        ...
                        "Roving Elves Moss Giant Dungeon Glarial's tomb" to
                                Tile(x = 2542, z = 9818, height = 0),
                        ...
                        "Karamja Shilo Village quest Dungeon" to
                                Tile(x = 2890, z = 9292, height = 0),
                        "Karamja Shilo Village quest Dungoen" to
                                Tile(x = 2891, z = 9387, height = 0),
                        "Karamja Shilo Village quest noth Bone key dungeon -end fight" to
                                Tile(x = 2893, z = 9487, height = 0),
                        "Karamja Jadinko lair dungeon" to Tile(x = 3037, z = 9237, height = 0),
                        "Recipe for Disaster underwater area" to
                                Tile(x = 2976, z = 9492, height = 0),
                        "Desert Enakhra's Lament Granite Dungeon" to
                                Tile(x = 3103, z = 9312, height = 0),
                        ...
                        "Desert Smokey Slayer dungeon main part" to
                                Tile(x = 3303, z = 4354, height = 0),
                        "Desert Kalphite Queen Dungeon" to Tile(x = 3499, z = 9492, height = 0),
                        "Desert Kalphite back enterance (lower level)" to
                                Tile(x = 3553, z = 9503, height = 0),
                        "Desert Spirits of the Elid river top" to
                                Tile(x = 3363, z = 9551, height = 0),
                        "Desert Eagle Cave" to Tile(x = 3426, z = 9570, height = 0),
                        "Mos Le Harmless bar basement" to Tile(x = 3666, z = 9394, height = 0),
                        "Mos Le Harmless Cave horror dungeon start" to
                                Tile(x = 3740, z = 9375, height = 0),
                        "Mos Le Harmless Cave horror dungeon exit to tree island" to
                                Tile(x = 3814, z = 9465, height = 0),
                        "Harmony underwater Dungeon (pretty sure, don't have mapdata)" to
                                Tile(x = 3796, z = 9254, height = 0),
                        ...
                        "Mort Myre/Canafis Dungeon outside blood altar" to
                                Tile(x = 3700, z = 9685, height = 0),
                        ...
                        "Resource Dungeon -Chaos Druid/Edgeville (10) -" to
                                Tile(x = 991, z = 4585, height = 0),
                        "Resource Dungeon -Dwarven Mine w/ bank(15) -" to
                                Tile(x = 1041, z = 4575, height = 0),
                        "Resource Dungeon - Hill Giants/Edgeville (20) -" to
                                Tile(x = 1134, z = 4590, height = 0),
                        "Resource Dungeon - Lesser Demons/Karamja (25) -" to
                                Tile(x = 1186, z = 4598, height = 0),
                        "Resource Dungeon - Fire Giants/Waterfall(35) -" to
                                Tile(x = 1256, z = 4592, height = 0),
                        "Resource Dungeon -Magic trees/Varrock Sewers (65) -" to
                                Tile(x = 1313, z = 4590, height = 0),
                        "Resource Dungeon -Hellhounds/Taverly(55) -" to
                                Tile(x = 1394, z = 4588, height = 0),
                        "Resource Dungeon  Runite Rocks/Mining Guild(45)-" to
                                Tile(x = 1052, z = 4521, height = 0),
                        "Resource Dungeon Blue D ragons/Taverly Dungeon(60) -" to
                                Tile(x = 1000, z = 4522, height = 0),
                        "Resource Dungeon Black Demon/Chaos Tunnels(70) -" to
                                Tile(x = 1110, z = 4460, height = 0),
                        "Resource Dungeon Metal Dragons/ Brimhaven(80) -" to
                                Tile(x = 1140, z = 4500, height = 0),
                        "Resource Dungeon Implings/Alkharid(75)" to
                                Tile(x = 1181, z = 4515, height = 0),
                        "Resource Dungeon Frost Dragons/Asgarnia Ice Dungeon(85)" to
                                Tile(x = 1297, z = 4510, height = 0),
                        "'Rum'-geon (braindeath isle) (not positive, missing mapdata)" to
                                Tile(x = 1053, z = 5005, height = 0),
                        "Scape-rune party-room" to Tile(x = 2085, z = 4463, height = 0),
                        "Keldagrim Ratpits" to Tile(x = 1953, z = 4704, height = 0),
                        "Dragonkin Castle (robert the strong cutscene)" to
                                Tile(x = 1891, z = 4527, height = 0),
                        "Draynor Christmas Event Factory" to Tile(x = 2006, z = 4440, height = 0),
                        "Pyramid Plunder" to Tile(x = 1958, z = 4449, height = 0),
                        "Waterbirth Dungeon -> Ladder to DKs" to
                                Tile(x = 1911, z = 4366, height = 0),
                        "While Guthix Sleeps Movaro(spellcheck) base" to
                                Tile(x = 2005, z = 4401, height = 0),
                        "While Guthix Sleeps Movaro(spellcheck) base2" to
                                Tile(x = 2074, z = 4383, height = 0),
                        "Lost goblin Plane Yubisk(spellcheck)" to
                                Tile(x = 2198, z = 4258, height = 0),
                        "Braindeath Island" to Tile(x = 2121, z = 5090, height = 0),
                        "Stronghold of Security ladder floor 1" to
                                Tile(x = 1860, z = 5244, height = 0),
                        "Stronghold of Security chest floor 1" to
                                Tile(x = 1907, z = 5221, height = 0),
                        "Stronghold of Security ladder floor 2" to
                                Tile(x = 2042, z = 5245, height = 0),
                        "Stronghold of Security chest floor 2" to
                                Tile(x = 2020, z = 5215, height = 0),
                        "Stronghold of Security ladder floor 3" to
                                Tile(x = 2122, z = 5251, height = 0),
                        "Stronghold of Security chest floor 3" to
                                Tile(x = 2144, z = 5281, height = 0),
                        "Stronghold of Security ladder floor 4" to
                                Tile(x = 2358, z = 5215, height = 0),
                        "Stronghold of Security chest floor 4" to
                                Tile(x = 2344, z = 5213, height = 0),
                        ...
                        "Wilderness Spirit Realm Rogue Castle" to
                                Tile(x = 2724, z = 4323, height = 0),
                        "Wilderness Spirit Realm Graveyard" to Tile(x = 2779, z = 4326, height = 0),
                        "Wilderness Spirit Realm Flying Axe hut" to
                                Tile(x = 2784, z = 4384, height = 0),
                        "Wilderness Spirit Realm Dark Knight Fortress/Tormented Wraith" to
                                Tile(x = 2848, z = 4382, height = 0),
                        "Wilderness Spirit Realm ???" to Tile(x = 2834, z = 4259, height = 0),
                        "Wilderness Spirit Realm Farm" to Tile(x = 2933, z = 4292, height = 0),
                        "Wilderness Spirit Realm Chaos Altar" to
                                Tile(x = 3296, z = 4187, height = 0),
                        "Wilderness Spirit Realm North-East Coast Ruins" to
                                Tile(x = 3230, z = 4186, height = 0),
                        "Goblin Altar Room" to Tile(x = 2784, z = 4251, height = 0),
                        "Daggonath Kings" to Tile(x = 2900, z = 4449, height = 0),
                        "Corporeal Beast quest dungeon area" to
                                Tile(x = 2985, z = 4386, height = 0),
                        ...
                        "Unstable Foundations tutorial quest three headed green dragon area" to
                                Tile(x = 3292, z = 4942, height = 0),
                        "Chaos Tunnel quest enterance (east of varrock)" to
                                Tile(x = 3150, z = 5233, height = 0),
                        "Pheonix Lair" to Tile(x = 3535, z = 5197, height = 0),
                        "Treasure chest island random event" to
                                Tile(x = 3290, z = 4703, height = 0),
                        ...
                        "Rimmington Basement I believe??? could be part of thieves guild quest" to
                                Tile(x = 4615, z = 5942, height = 0),
                        ...
                        "Ardougne West Ardougne underground pass" to
                                Tile(x = 2445, z = 3316, height = 0),
                        "Ardougne West Ardougne Training Camp" to
                                Tile(x = 2521, z = 3368, height = 0),
                        "Ardougne West Ardougne Chaos Tower" to
                                Tile(x = 2562, z = 3356, height = 0),
                        ...
                        "Barbarian Outpost Barbarian Assault" to
                                Tile(x = 2535, z = 3567, height = 0),
                        ...
                        "Karamja Kharzai Jungle Jadinko area" to
                                Tile(x = 2956, z = 2914, height = 0),
                        "Karamja Kharzai Jungle Jadinko area island" to
                                Tile(x = 2976, z = 2911, height = 0),
                        ...
                        "Troll Stronghold Trollweiss Mountain" to
                                Tile(x = 2791, z = 3853, height = 0),
                        "Troll Stronghold Wilderness Castle" to
                                Tile(x = 2913, z = 3933, height = 0),
                        ...
                        "Kharidian Desert Al Kharid  Duel Arena" to
                                Tile(x = 3363, z = 3268, height = 0),
                        "Kharidian Desert Al Kharid Mage Trainning Arena" to
                                Tile(x = 3362, z = 3317, height = 0),
                        ...
                        "Wilderness King Black Dragon KBD lair" to
                                Tile(x = 3015, z = 3849, height = 0),
    ...
    init {
        ...
        val portalObjects =
                listOf(
                        "object.portal_nexus_33410", // 33410 - Crystalline Portal Nexus (Regular) -
                        // PRIMARY
                ...
                try {
                    ...
                    if (objHasOption(portalId, option)) {
                        onObjOption(obj = portalId, option = option) {
                            ...
                            player.queue(TaskPriority.STRONG) { openTeleportMenu(player) }
                        }
                        optionBound = true
    ...
    /**
     * Opens the paginated teleport menu for the player This is a suspend function that runs within
     * a QueueTask context Uses a full-screen interface (187) with the crystalline portal nexus item
     * display
     */
    private suspend fun QueueTask.openTeleportMenu(p: Player) {
        ...
        p.runClientScript(
                CommonClientScripts.INTERFACE_MENU,
                title,
