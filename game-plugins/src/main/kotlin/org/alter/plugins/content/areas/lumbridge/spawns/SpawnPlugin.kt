...
class SpawnPlugin(
    ...
    init {
        ...
        // Chickens at 3230, 3298 (10 spawns)
        spawnNpc(npc = "npc.chicken_1173", x = 3230, z = 3298, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1173", x = 3228, z = 3298, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1174", x = 3232, z = 3298, walkRadius = 5, direction = Direction.WEST)
        spawnNpc(npc = "npc.chicken_1173", x = 3230, z = 3296, walkRadius = 5, direction = Direction.NORTH)
        spawnNpc(npc = "npc.chicken_1174", x = 3230, z = 3300, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1173", x = 3229, z = 3297, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1174", x = 3231, z = 3299, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1173", x = 3227, z = 3298, walkRadius = 5, direction = Direction.WEST)
        spawnNpc(npc = "npc.chicken_1174", x = 3233, z = 3298, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1173", x = 3230, z = 3301, walkRadius = 5, direction = Direction.NORTH)
        
        // Chickens at 3179, 3295 (10 spawns)
        spawnNpc(npc = "npc.chicken_1173", x = 3179, z = 3295, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1174", x = 3177, z = 3295, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1173", x = 3181, z = 3295, walkRadius = 5, direction = Direction.WEST)
        spawnNpc(npc = "npc.chicken_1174", x = 3179, z = 3293, walkRadius = 5, direction = Direction.NORTH)
        spawnNpc(npc = "npc.chicken_1173", x = 3179, z = 3297, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1174", x = 3178, z = 3294, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1173", x = 3180, z = 3296, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1174", x = 3176, z = 3295, walkRadius = 5, direction = Direction.WEST)
        spawnNpc(npc = "npc.chicken_1173", x = 3182, z = 3295, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1174", x = 3179, z = 3298, walkRadius = 5, direction = Direction.NORTH)
        
        // Chickens at 3188, 3278 (3 spawns)
        spawnNpc(npc = "npc.chicken_1173", x = 3188, z = 3278, walkRadius = 5, direction = Direction.SOUTH)
        spawnNpc(npc = "npc.chicken_1174", x = 3187, z = 3278, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.chicken_1173", x = 3189, z = 3278, walkRadius = 5, direction = Direction.WEST)
        ...
        spawnNpc(npc = "npc.guard_397", x = 3117, z = 3245, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.guard_397", x = 3119, z = 3247, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.guard_397", x = 3121, z = 3249, walkRadius = 5, direction = Direction.EAST)
        spawnNpc(npc = "npc.guard_397", x = 3123, z = 3251, walkRadius = 5, direction = Direction.EAST)
