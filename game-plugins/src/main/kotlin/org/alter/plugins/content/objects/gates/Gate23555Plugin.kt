 ...
 * Gate 23555 Plugin
 * 
 * This plugin handles gate 23555, which teleports players to coordinates (2998, 3916)
 * when interacted with.
 * 
 * Gate Object: door_23555 (object 23555)
 * Teleport Destination: (2998, 3916)
 */
class Gate23555Plugin(
    r: PluginRepository,
    world: World,
    server: Server
    ...
    companion object {
         ...
         */
        private val TELEPORT_DESTINATION = Tile(x = 2998, z = 3916, height = 0)
        
        /**
         * Gate object ID
         */
        private const val GATE_ID = 23555
    }
    ...
    init {
        ...
        // Handle gate 23555 - try multiple options
        ...
        try {
            if (objHasOption("object.door_23555", "open") && !registeredOptions.contains("open")) {
                try {
                    onObjOption(obj = "object.door_23555", option = "open", lineOfSightDistance = 1) {
                        teleportPlayer()
                    }
            ...
            if (objHasOption("object.door_23555", "enter") && !registeredOptions.contains("enter")) {
                try {
                    onObjOption(obj = "object.door_23555", option = "enter", lineOfSightDistance = 1) {
                        teleportPlayer()
                    }
            ...
            if (objHasOption("object.door_23555", "use") && !registeredOptions.contains("use")) {
                try {
                    onObjOption(obj = "object.door_23555", option = "use", lineOfSightDistance = 1) {
                        teleportPlayer()
                    }
        ...
        if (registeredOptions.isEmpty()) {
            try {
                onObjOption(obj = "object.door_23555", option = 1, lineOfSightDistance = 1) {
                    teleportPlayer()
                }
            } catch (e: IllegalStateException) {
                // Option already bound
